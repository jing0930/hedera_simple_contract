...
async function main() {
  ...
  const contractInstantiateTx = new ContractCreateTransaction()
    ...
    .setConstructorParameters(
      new ContractFunctionParameters().addString("Jing").addUint256(8562029)
    );
  ...
  const contractQueryTx = new ContractCallQuery()
    ...
    .setFunction(
      "getMobileNumber",
      new ContractFunctionParameters().addString("Jing")
    )
  ...
  const contractExecuteTx = new ContractExecuteTransaction()
    ...
    .setFunction(
      "setMobileNumber",
      new ContractFunctionParameters().addString("Eric").addUint256(5050505)
    )
    .setMaxTransactionFee(new Hbar(0.75));
  ...
  const contractQueryTx1 = new ContractCallQuery()
    ...
    .setFunction(
      "getMobileNumber",
      new ContractFunctionParameters().addString("Eric")
    );
